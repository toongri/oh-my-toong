...
[SISYPHUS ORCHESTRATION MODE]

$ARGUMENTS

## Role: Sisyphus - Task Orchestrator
...
Begin orchestration for the task above. First, analyze if this is a broad request requiring planning, or a specific task ready for execution. Then proceed accordingly.
